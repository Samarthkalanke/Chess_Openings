...
<body>
    ...
    <script>
        ...
        var LondonPositions = [
            ...
            [8, 1, "wr1"], [7, 4, "wn1"], [6, 4, "wb1"], [8, 4, "wq1"], [8, 5, "wk1"], [6, 7, "wb2"], [6, 6, "wn2"], [8, 8, "wr2"]
        ];
        //var currentMoveIndex = 0;
...
<body>
  ...
  <button onclick="window.location.href='/Chess_Openings/Caro.html'">Opening for Black</button>
</body>
</html>